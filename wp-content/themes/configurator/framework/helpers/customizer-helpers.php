...
if( !function_exists( 'configurator_print_title_bar' ) ) {
	function configurator_print_title_bar() {
		...
		if( is_home() || is_archive() || is_search() || is_404() || configurator_is_shop() ) {
			...
			$values['title_bar_style']     = get_theme_mod( $prefix.'title_bar_style', 'sub-banner-center' );	
			...
			$values['title_bar_style']     = configurator_get_meta_value( $page_id, '_amz_title_bar_style', 'default', $opt_prefix.'title_bar_style', 'sub-banner-center' );
