...
function configurator_scripts() {
	...
	wp_enqueue_style( 'configurator-stylesheet', get_template_directory_uri() . '/assets/css/main.css', array(), '1.1', 'all' );
	wp_enqueue_style( 'configurator-responsive-stylesheet', get_template_directory_uri() . '/assets/css/'. $responsive .'responsive.css', array('configurator-stylesheet'), '1.1', 'all' );
	wp_enqueue_style( 'owl-carousel', get_template_directory_uri() . '/assets/css/owl-carousel.css', array( 'configurator-responsive-stylesheet' ), '1.1', 'all' );
	...
	wp_enqueue_script( 'configurator-js', get_template_directory_uri() . '/assets/js/scripts.js', array( 'jquery' ), '1.1', true );
