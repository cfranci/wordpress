	...
	<div class="single-product-content clearfix">
		...
		<div class="summary entry-summary">
			...
			<?php
				...
				if ( is_customize_preview() ) { echo '<div class="customize-single-product-wishlist">'; }
					echo configurator_print_single_product_wishlist();
				if ( is_customize_preview() ) { echo '</div>'; }

				global $product;
				$tag_count = sizeof( get_the_terms( $product->get_id(), 'product_tag' ) );
				echo '<div class="product-meta">'. wc_get_product_tag_list( $product->get_id() ) .'</div>';
